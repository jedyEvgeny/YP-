...
// 	lengthPool := 50
// 	countPool := 2
// 	fmt.Println(ShowTrainingInfo(action, trainingType, duration, weight, height, lengthPool, countPool))
// 	fmt.Println("Должно быть:")
// 	fmt.Println("Тип тренировки: Бег\nДлительность: 0.15 ч.\nДистанция: 2.60 км.\nСкорость: 17.33 км/ч\nСожгли калорий: 427.24")
// 	fmt.Println("*****")
...
// 	fmt.Println(ShowTrainingInfo(action, trainingType, duration, weight, height, lengthPool, countPool))
// 	fmt.Println("Должно быть:")
// 	fmt.Println("Тип тренировки: Ходьба\nДлительность: 1.00 ч.\nДистанция: 2.60 км.\nСкорость: 2.60 км/ч\nСожгли калорий: 220.27")
// 	fmt.Println("*****")
...
// 	fmt.Println(ShowTrainingInfo(action, trainingType, duration, weight, height, lengthPool, countPool))
// 	fmt.Println("Должно быть:")
// 	fmt.Println("Тип тренировки: Плавание\nДлительность: 0.25 ч.\nДистанция: 0.65 км.\nСкорость: 1.60 км/ч\nСожгли калорий: 114.75")
// 	fmt.Println("*****")
